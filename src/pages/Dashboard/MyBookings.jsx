...
const MyBookings = () => {
    ...
    //     queryKey: ['bookings'],
    //     queryFn: async() =>{
    //         const res = await fetch(`https://the-urban-nest-server.vercel.app/bookings?email=${user.email}`);
    ...
    const handleDeleteItem = booking => {
        ...
        fetch(`https://the-urban-nest-server.vercel.app/bookings/${booking.email}`, {
            method: 'DELETE',
            headers: {
